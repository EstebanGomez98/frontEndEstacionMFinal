function openWeatherLocation(loc) {
   ...
   var forecast;
    ...
    var html=Card(showData, weather, forecast);
    document.getElementById("cardTemp").value=html;
}


function Card (showData, weather, forecast) {
